...
public class ProductSpecs {
    ...
    public static Specification<Product> factoryLike(List<String> name) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.in(root.get(Product_.FACTORY)).value(name);
    }
